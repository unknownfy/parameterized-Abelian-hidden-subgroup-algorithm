...
#SBATCH --output=hpctset_%j.log      # Standard output
...
OUTPUT=/home/feiyanliu3/scratch/hpctest.output

mpirun -genv OMP_NUM_THREADS=4 -genv I_MPI_PIN=1 -genv OMP_PROC_BIND=true -genv OMP_PLACES=cores $MATLAB  < hpctset.m > $OUTPUT
