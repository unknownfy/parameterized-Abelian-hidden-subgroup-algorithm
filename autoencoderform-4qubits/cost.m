...
%we add the threshold to aviod s=0000 and lead s to integer
costvalue = real(sum((sum(sum(linearoutput)))))+1./(1+exp(100*s(1)-10)+exp(100*s(2)-10)+exp(100*s(3)-10)+exp(100*s(4)-10))+sin(s(1)*pi)^2+sin(s(2)*pi)^2+sin(s(3)*pi)^2+sin(s(4)*pi)^2+...
    sin(l(1)*2)^2+sin(l(2)*2)^2+sin(l(3)*2)^2+sin(l(4)*2)^2+sin(l(5)*2)^2+sin(l(6)*2)^2;
end